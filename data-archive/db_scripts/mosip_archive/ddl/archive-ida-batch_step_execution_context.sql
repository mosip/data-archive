-- Table: archive.mosip_ida_batch_step_execution_context

-- DROP TABLE archive.mosip_ida_batch_step_execution_context;

CREATE TABLE archive.mosip_ida_batch_step_execution_context
(
