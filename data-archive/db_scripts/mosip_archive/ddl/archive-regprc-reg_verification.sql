...
-- object: archive.mosip_regprc_reg_verification | type: TABLE --
-- DROP TABLE IF EXISTS archive.mosip_regprc_reg_verification CASCADE;
CREATE TABLE archive.mosip_regprc_reg_verification(
