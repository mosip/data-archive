...
def config(filename='mosip_archive_ida.ini'):
    ...
    dbparam["source_ida_db_serverip"] = os.environ.get("SOURCE_IDA_DB_SERVERIP")
    dbparam["source_ida_db_port"] = os.environ.get("SOURCE_IDA_DB_PORT")
    dbparam["source_ida_db_uname"] = os.environ.get("SOURCE_IDA_DB_UNAME")
    dbparam["source_ida_db_pass"] = os.environ.get("SOURCE_IDA_DB_PASS")
