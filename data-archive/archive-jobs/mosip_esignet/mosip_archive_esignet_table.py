...
def config(filename='mosip_archive_esignet.ini'):
    ...
    dbparam["source_esignet_db_serverip"] = os.environ.get("SOURCE_ESIGNET_DB_SERVERIP")
    dbparam["source_esignet_db_port"] = os.environ.get("SOURCE_ESIGNET_DB_PORT")
    dbparam["source_esignet_db_uname"] = os.environ.get("SOURCE_ESIGNET_DB_UNAME")
    dbparam["source_esignet_db_pass"] = os.environ.get("SOURCE_ESIGNET_DB_PASS")
