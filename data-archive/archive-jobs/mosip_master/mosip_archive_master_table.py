...
def config(filename='mosip_archive_master.ini'):
    parser = ConfigParser()
    ...
    dbparam["source_master_db_serverip"] = os.environ.get("SOURCE_MASTER_DB_SERVERIP")
    dbparam["source_master_db_port"] = os.environ.get("SOURCE_MASTER_DB_PORT")
    dbparam["source_master_db_uname"] = os.environ.get("SOURCE_MASTER_DB_UNAME")
    dbparam["source_master_db_pass"] = os.environ.get("SOURCE_MASTER_DB_PASS")
