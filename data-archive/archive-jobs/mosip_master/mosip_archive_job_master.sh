#export SOURCE_MASTER_DB_SERVERIP=172.16.0.162
#export SOURCE_MASTER_DB_PORT=30093
#export SOURCE_MASTER_DB_UNAME=dbuser
#export SOURCE_MASTER_DB_PASS=mosip123
