...
#-- -------------------------------------------------------------------------------------------------
#-- Job Name        : Resident DB Tables Archive
#-- DB Name 	    : mosip_resident
#-- Table Names     : otp_transaction
#-- Purpose    	    : Job to Archive Data in Resident DB for above mentioned tables         
...
def config(filename='mosip_archive_resident.ini', section='MOSIP-DB-SECTION'):
    parser = ConfigParser()
