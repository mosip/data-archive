...
def config():
    ...
    dbparam["SOURCE_RESIDENT_DB_SERVERIP"] = os.environ.get("SOURCE_RESIDENT_DB_SERVERIP") or dbparam.get("SOURCE_RESIDENT_DB_SERVERIP")
    dbparam["SOURCE_RESIDENT_DB_PORT"] = os.environ.get("SOURCE_RESIDENT_DB_PORT") or dbparam.get("SOURCE_RESIDENT_DB_PORT")
    dbparam["SOURCE_RESIDENT_DB_NAME"] = os.environ.get("SOURCE_RESIDENT_DB_NAME") or dbparam.get("SOURCE_RESIDENT_DB_NAME")
    dbparam["SOURCE_RESIDENT_SCHEMA_NAME"] = os.environ.get("SOURCE_RESIDENT_SCHEMA_NAME") or dbparam.get("SOURCE_RESIDENT_SCHEMA_NAME")
    dbparam["SOURCE_RESIDENT_DB_UNAME"] = os.environ.get("SOURCE_RESIDENT_DB_UNAME") or dbparam.get("SOURCE_RESIDENT_DB_UNAME")
    dbparam["SOURCE_RESIDENT_DB_PASS"] = os.environ.get("SOURCE_RESIDENT_DB_PASS") or dbparam.get("SOURCE_RESIDENT_DB_PASS")
