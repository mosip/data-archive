...
def config(filename='mosip_archive_regprc.ini'):
    parser = ConfigParser()
    ...
    dbparam["source_regprc_db_serverip"] = os.environ.get("SOURCE_REGPRC_DB_SERVERIP")
    dbparam["source_regprc_db_port"] = os.environ.get("SOURCE_REGPRC_DB_PORT")
    dbparam["source_regprc_db_uname"] = os.environ.get("SOURCE_REGPRC_DB_UNAME")
    dbparam["source_regprc_db_pass"] = os.environ.get("SOURCE_REGPRC_DB_PASS")
