...
def config(filename='mosip_archive_kernel.ini'):
    ...
    dbparam["source_kernel_db_serverip"] = os.environ.get("SOURCE_DB_SERVERIP")
    dbparam["source_kernel_db_port"] = os.environ.get("SOURCE_DB_PORT")
    dbparam["source_kernel_db_uname"] = os.environ.get("SOURCE_DB_UNAME")
    dbparam["source_kernel_db_pass"] = os.environ.get("SOURCE_DB_PASS")
