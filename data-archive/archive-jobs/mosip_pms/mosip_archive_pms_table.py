...
def config(filename='mosip_archive_pms.ini'):
    parser = ConfigParser()
    ...
    dbparam["source_pms_db_serverip"] = os.environ.get("SOURCE_PMS_DB_SERVERIP")
    dbparam["source_pms_db_port"] = os.environ.get("SOURCE_PMS_DB_PORT")
    dbparam["source_pms_db_uname"] = os.environ.get("SOURCE_PMS_DB_UNAME")
    dbparam["source_pms_db_pass"] = os.environ.get("SOURCE_PMS_DB_PASS")
