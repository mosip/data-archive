...
def config(filename='mosip_archive_credential.ini'):
    ...
    dbparam["source_credential_db_serverip"] = os.environ.get("SOURCE_CREDENTIAL_DB_SERVERIP")
    dbparam["source_credential_db_port"] = os.environ.get("SOURCE_CREDENTIAL_DB_PORT")
    dbparam["source_credential_db_uname"] = os.environ.get("SOURCE_CREDENTIAL_DB_UNAME")
    dbparam["source_credential_db_pass"] = os.environ.get("SOURCE_CREDENTIAL_DB_PASS")
