...
def config():
    ...
    dbparam["SOURCE_CREDENTIAL_DB_SERVERIP"] = os.environ.get("SOURCE_CREDENTIAL_DB_SERVERIP") or dbparam.get("SOURCE_CREDENTIAL_DB_SERVERIP")
    dbparam["SOURCE_CREDENTIAL_DB_PORT"] = os.environ.get("SOURCE_CREDENTIAL_DB_PORT") or dbparam.get("SOURCE_CREDENTIAL_DB_PORT")
    dbparam["SOURCE_CREDENTIAL_DB_NAME"] = os.environ.get("SOURCE_CREDENTIAL_DB_NAME") or dbparam.get("SOURCE_CREDENTIAL_DB_NAME")
    dbparam["SOURCE_CREDENTIAL_SCHEMA_NAME"] = os.environ.get("SOURCE_CREDENTIAL_SCHEMA_NAME") or dbparam.get("SOURCE_CREDENTIAL_SCHEMA_NAME")
    dbparam["SOURCE_CREDENTIAL_DB_UNAME"] = os.environ.get("SOURCE_CREDENTIAL_DB_UNAME") or dbparam.get("SOURCE_CREDENTIAL_DB_UNAME")
    dbparam["SOURCE_CREDENTIAL_DB_PASS"] = os.environ.get("SOURCE_CREDENTIAL_DB_PASS") or dbparam.get("SOURCE_CREDENTIAL_DB_PASS")
...
def dataArchive():
    ...
    try:
        ...
        sourceConn = psycopg2.connect(user=dbparam["SOURCE_CREDENTIAL_DB_UNAME"],
                                      password=dbparam["SOURCE_CREDENTIAL_DB_PASS"],
                                      host=dbparam["SOURCE_CREDENTIAL_DB_SERVERIP"],
                                      port=dbparam["SOURCE_CREDENTIAL_DB_PORT"],
                                      database=dbparam["SOURCE_CREDENTIAL_DB_NAME"])
        ...
        sschemaName = dbparam["SOURCE_CREDENTIAL_SCHEMA_NAME"]
